...
public:
    static const std::unordered_map<Levels, SongData>& GetAllSong() {
        static const std::unordered_map<Levels, SongData> s_Songs = {
            ...
            {Levels::Chronos, SongData{Levels::Chronos, "Chronos", "Danimal Cannon & Zef", SongsBPM::Chronos, "../Resources/Audio/Chronos.wav", "../Resources/Audio/Reverse/Chronos_reverse.ogg"}},
            {Levels::MilkyWay, SongData{Levels::MilkyWay, "Milky Way", "Bossfight", SongsBPM::MilkyWay, "../Resources/Audio/Milky Way.wav", "../Resources/Audio/Reverse/Milky Way_reverse.ogg"}},
            {Levels::CheatCodes, SongData{Levels::CheatCodes, "Cheat Codes", "Nitro Fun", SongsBPM::CheatCodes, "../Resources/Audio/Cheat Codes.wav", "../Resources/Audio/Reverse/Cheat Codes_reverse.ogg"}}
        };
        return s_Songs;
    };
